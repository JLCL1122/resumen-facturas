...
⚠️ La carpeta facturas_xml/ se utiliza solo de forma local para colocar los CFDI XML y está excluida del repositorio mediante .gitignore por seguridad y privacidad de la información fiscal.
...
1. Crear una carpeta llamada facturas_xml en la raíz del proyecto
2. Colocar dentro los archivos XML de las facturas CFDI
3. Definir el RFC como variable de entorno:

Linux / macOS:
    export MI_RFC=TU_RFC_AQUI

Windows (PowerShell):
    $env:MI_RFC="TU_RFC_AQUI"
...
Proyecto desarrollado por Jorge Castro como parte de un portafolio de automatización de procesos en Python,
enfocado en soluciones contables y financieras.
